"""
Django settings for captionists project.
...
SECRET_KEY = 'wqq3a#h57#=h2x6^#x)75=j2=glci)p!l0e7-pbhmstbz@74mz'
...
WSGI_APPLICATION = 'captionists.wsgi.application'
